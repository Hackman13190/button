...
function pasteTextArea() {
    ...
    navigator.clipboard.readText()
        ...
        .catch((error) => {
            console.error("An unexpected error occurred.\nPlease retry and check for any mistakes.\nIf the issue persists, please contact us.");
            alert("Verify that the text is correctly copied without any errors and authorize the site to access your clipboard.\nIf the issue persists, please contact us.")
        });
}

function clearTextArea() {
    var userInput = document.getElementById('userInput');
    userInput.value = ""; // Efface tout le texte dans le textarea
}
